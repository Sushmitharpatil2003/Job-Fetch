...
SERPAPI_KEY = "19ca79f3c939d9648df6f06a2ab47208aaedc7e91054dcea450c2d41a67f397d"  # <- Replace with your actual key
...
def serpapi_search(query, api_key, num_results=20):
...
def main():
    ...
    for query in queries:
        print(f"\n🔍 Searching: {query}")
        urls = serpapi_search(query, SERPAPI_KEY, num_results=20)
        human_pause()
    ...
    with open("event_urls_serpapi.json", "w") as f:
        json.dump(all_data, f, indent=2)

    pd.DataFrame(all_data).to_excel("event_urls_serpapi.xlsx", index=False)
    print("\n📁 Saved: event_urls_serpapi.json and event_urls_serpapi.xlsx")
